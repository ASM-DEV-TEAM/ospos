...
<div id="page-wrap">
    <?= view('sales/thermal_items_style', ['include_hsn' => false]) ?>
    ...
    <table id="items">
        ...
        ?>
                <tr class="item-row">
                    ...
                    <td class="col-disc" style="text-align: center;"><?= ($item['discount_type'] == FIXED) ? to_currency($item['discount']) : to_decimals($item['discount']) . '%' ?></td>
