...
<div id="page-wrap">
    <?= view('sales/thermal_items_style', ['include_hsn' => $include_hsn]) ?>
    ...
    <table id="items">
        ...
        ?>
                ...
                <td class="col-disc" style="height: center;"><?= ($item['discount_type'] == FIXED) ? to_currency($item['discount']) : to_decimals($item['discount']) . '%' ?></td>
